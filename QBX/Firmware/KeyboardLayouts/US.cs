...
public class US(Machine machine) : CapsToggleKeyboardLayout(machine)
{
		...
		if (scanCode == default)
		{
			...
			if (modifiers.AltKey)
			{
				switch (rawData.RawScanCode)
				{
					...
					case SDL.Scancode.Kp7: scanCode = ScanCode.Home; break;
					case SDL.Scancode.Kp8: scanCode = ScanCode.Up; break;
					case SDL.Scancode.Kp9: scanCode = ScanCode.PageUp; break;
					case SDL.Scancode.KpPlus: scanCode = ScanCode.KpPlus; break;
					case SDL.Scancode.Kp4: scanCode = ScanCode.Left; break;
					case SDL.Scancode.Kp5: scanCode = ScanCode.Kp5; break;
					case SDL.Scancode.Kp6: scanCode = ScanCode.Right; break;
					case SDL.Scancode.Kp1: scanCode = ScanCode.End; break;
					case SDL.Scancode.Kp2: scanCode = ScanCode.Down; break;
					case SDL.Scancode.Kp3: scanCode = ScanCode.PageDown; break;
					case SDL.Scancode.KpEnter: scanCode = ScanCode.AltKpEnter; break;
					case SDL.Scancode.Kp0: scanCode = ScanCode.Insert; break;
