...
public class LongLessThanOrEquals(IEvaluable left, IEvaluable right) : IEvaluable
{
...
public class SingleLessThanOrEquals(IEvaluable left, IEvaluable right) : IEvaluable
{
	public IEvaluable Left => left;
	public IEvaluable Right => right;
...
public class DoubleLessThanOrEquals(IEvaluable left, IEvaluable right) : IEvaluable
{
	public IEvaluable Left => left;
	public IEvaluable Right => right;
...
public class CurrencyLessThanOrEquals(IEvaluable left, IEvaluable right) : IEvaluable
{
	public IEvaluable Left => left;
	public IEvaluable Right => right;
...
public class StringLessThanOrEquals(IEvaluable left, IEvaluable right) : IEvaluable
{
	public IEvaluable Left => left;
	public IEvaluable Right => right;
...
public class IntegerLessThanOrEquals(IEvaluable left, IEvaluable right) : IEvaluable
{
	public IEvaluable Left => left;
	public IEvaluable Right => right;
