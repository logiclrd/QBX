...
public class IntegerOr(Evaluable left, Evaluable right) : BinaryExpression(left, right)
{
...
public class LongOr(Evaluable left, Evaluable right) : BinaryExpression(left, right)
{
