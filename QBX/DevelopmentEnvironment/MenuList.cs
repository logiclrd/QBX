...
public class MenuList<TItem>(string label, string? helpContextString = null) : MenuItem(label, referenceText: null, helpContextString), IList<TItem>, IEnumerable<TItem>
