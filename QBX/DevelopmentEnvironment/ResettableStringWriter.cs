...
public class ResettableStringWriter : TextWriter
{
	...
	public ResettableStringWriter(IFormatProvider? formatProvider)
	...
	//
	public ResettableStringWriter(StringBuilder sb) : this(sb, CultureInfo.CurrentCulture)
	{
	}

	public ResettableStringWriter(StringBuilder sb, IFormatProvider? formatProvider) : base(formatProvider)
	{
	...
	{
		if (!_isOpen)
			throw new ObjectDisposedException("ResettableStringWriter");
