...
public class WatchpointDialog : Dialog
{
	public event Action? AddWatch;

	public string WatchpointExpression => txtExpression.Text.ToString();
	...
	public WatchpointDialog(Machine machine, Configuration configuration)
	...
	void InitializeComponent()
	{
		...
		lblPrompt.X = 6;
		lblPrompt.Y = 1;
		lblPrompt.Text = "Enter expression (will break when TRUE):";
		lblPrompt.AutoSize();
