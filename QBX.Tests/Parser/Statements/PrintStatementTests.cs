...
public class PrintStatementTests
{
	...
	[TestCase("PRINT TAB(2);", false, false, 1, PrintCursorAction.None)]
	[TestCase("PRINT SPC(2);", false, false, 1, PrintCursorAction.None)]
	[TestCase("PRINT SPC(2),", false, false, 2, PrintCursorAction.NextZone)]
	[TestCase("PRINT SPC(5); a%; TAB(b%); c%,", false, false, 4, PrintCursorAction.NextZone)]
